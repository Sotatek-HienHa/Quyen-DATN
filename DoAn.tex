...
\titleformat
    ...
    [hang]
    {\bfseries}
    {\thesubsubsection\ } % <-- Đây là chỗ cần giữ nguyên
    {0pt}
    {}
    []
...
\setcounter{secnumdepth}{5} % Cho phép subsubsection trong report
\setcounter{tocdepth}{5} % Chèn subsubsection vào bảng mục lục
\renewcommand{\thesubsubsection}{\thesubsection.\arabic{subsubsection}}
